...
public class SwiftAppCenterAnalyticsPlugin: NSObject, FlutterPlugin, AppCenterApi, AppCenterAnalyticsApi, AppCenterCrashesApi {
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let binaryMessenger = registrar.messenger()
        let appCenterPlugin = SwiftAppCenterAnalyticsPlugin()
