...
class AppCenterApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AppCenterApi?) {
    let setUserIdChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.setUserId", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let startChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.start", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.setEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.isEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isConfiguredChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.isConfigured", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getInstallIdChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.getInstallId", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let isRunningInAppCenterTestCloudChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterApi.isRunningInAppCenterTestCloud", binaryMessenger: binaryMessenger)
    if let api = api {
...
class AppCenterAnalyticsApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AppCenterAnalyticsApi?) {
    let trackEventChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.trackEvent", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let pauseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.pause", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let resumeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.resume", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let analyticsSetEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.analyticsSetEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let analyticsIsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.analyticsIsEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let enableManualSessionTrackerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.enableManualSessionTracker", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let startSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.startSession", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setTransmissionIntervalChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterAnalyticsApi.setTransmissionInterval", binaryMessenger: binaryMessenger)
    if let api = api {
...
class AppCenterCrashesApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AppCenterCrashesApi?) {
    let generateTestCrashChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.generateTestCrash", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let hasReceivedMemoryWarningInLastSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.hasReceivedMemoryWarningInLastSession", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let hasCrashedInLastSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.hasCrashedInLastSession", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let crashesSetEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.crashesSetEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let crashesIsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.crashesIsEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let trackExceptionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter_analytics.AppCenterCrashesApi.trackException", binaryMessenger: binaryMessenger)
    if let api = api {
