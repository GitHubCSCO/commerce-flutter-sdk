import 'package:appcenter_analytics/src/appcenter/appcenter_platform_interface.dart';
...
class AppCenter {
  ...
  static Future<void> setUserId({required final String userId}) =>
      AppCenterPlatformInterface.instance.setUserId(userId: userId);
