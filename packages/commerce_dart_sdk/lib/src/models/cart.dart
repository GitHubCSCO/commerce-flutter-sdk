...
class Cart extends BaseModel {
  ...
  @JsonKey(
    ...
    includeToJson: true,
    name: 'requestedDeliveryDateDisplay',
  )
  DateTime? _requestedDeliveryDateDisplay;
  DateTime? get requestedDeliveryDateDisplay => _requestedDeliveryDateDisplay;
  ...
  @JsonKey(
    includeFromJson: true,
    includeToJson: true,
    name: 'requestedPickUpDateDisplay',
  )
  DateTime? _requestedPickUpDateDisplay;
  DateTime? get requestedPickUpDateDisplay => _requestedPickUpDateDisplay;
...
class PaymentOptionsDto {
  ...
  List<Map<String, int>>? expirationMonths;

  /// Gets or sets the expiration years.
  List<Map<int, int>>? expirationYears;
...
class CartLineCollectionDto {
  ...
  CartLineCollectionDto({this.cartLines});
