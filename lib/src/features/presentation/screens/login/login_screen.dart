                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          BlocListener<SettingsDomainCubit,
                              SettingsDomainState>(
                            ...
                            child: BlocBuilder<RemoteConfigCubit,
                                RemoteConfigState>(
                              builder: (context, state) {
                                if (state
                                    is RemoteConfigDebugCredentialsLoaded) {
                            ...
                            listener: (context, state) async {
                              if (state is LoginSuccessState) {
                                ...
                                if (state.loginStatus ==
                                  ...
                                  final biometricOptionsState = context
                                      .read<BiometricOptionsCubit>()
                                      .state;
