...
enum LocalizationConstants {
  ...
  returnNotes(keyword: "Return Notes"),
  ...
  subtotalItems(keyword: "Subtotal (%s Items)"),
  subtotalItem(keyword: "Subtotal (%s Item)"),
  ...
  carrier(keyword: "Delivery Options"),
  ...
  selectCarrier(keyword: "Select Delivery Options"),
  ...
  failedToCopyOrderNumberToClipboard(
      keyword: "Failed to copy order number to clipboard"),
