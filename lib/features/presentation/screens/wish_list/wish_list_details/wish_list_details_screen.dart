            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final canEditWishList = 
                    (state.wishList.allowEditingBySharedWithUsers == true || state.wishList.isSharedList!=true) 
                ...
                return WishListLineWidget(
                  ...
                  realTimeLoading: state.status == WishListStatus.realTimeAttributesLoading,
                  isDeleteButtonVisible: canEditWishList,
                  canEditQuantity: line.canEnterQuantity == true && canEditWishList,
                );
              },
