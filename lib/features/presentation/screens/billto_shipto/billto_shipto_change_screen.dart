...
class _BillToShipToChangePageState extends State<BillToShipToChangePage> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TabSwitchWidget(
                      ...
                      tabWidget0: _buildShipToWidget(state.shipToAddress),
                      tabWidget1: _buildPickUpWidget(state.pickUpWarehouse, state.recipientAddress),
                    ),
                    Padding(
  ...
  Widget _buildShipToWidget(ShipTo? shipTo) {
    return Padding(
      padding: const EdgeInsets.all(20.0),
      child: Row(
        mainAxisSize: MainAxisSize.max,
  ...
  Widget _buildPickUpWidget(Warehouse? wareHouse, ShipTo? recipientAddress) {
    return Padding(
      padding: const EdgeInsets.all(20.0),
      child: Column(
        children: [
