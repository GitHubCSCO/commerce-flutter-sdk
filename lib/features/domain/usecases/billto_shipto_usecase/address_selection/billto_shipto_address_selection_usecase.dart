...
class BillToShipToAddressSelectionUseCase extends BaseUseCase {
  ...
  Future<Result<GetBillTosResult, ErrorResponse>> getBillToAddresses(String searchQuery, int currentPage) async {
  ...
  Future<Result<GetShipTosResult, ErrorResponse>> getShipToAddresses(String billToId, String searchQuery, int currentPage) async {
