...
class ProductDetailAddtoCartEntity extends ProductDetailsBaseEntity {
  ...
  const ProductDetailAddtoCartEntity({
  ...
  @override
  ProductDetailAddtoCartEntity copyWith({
    ...
    return ProductDetailAddtoCartEntity(
