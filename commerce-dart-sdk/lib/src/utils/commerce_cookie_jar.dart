...
/// [CommerceCookieJar] saves the cookies in the memory, all cookies will be
/// cleared after the app exited.
///
/// In order to save cookies into storages, use [PersistCookieJar] instead.
class CommerceCookieJar implements CookieJar {
  CommerceCookieJar({this.ignoreExpires = false});
  ...
  Future<void> saveFromResponse(Uri uri, List<Cookie> cookies) async {
    for (final cookie in cookies) {
      // Skip saving the ".AspNet.ApplicationCookie" cookie. app will operate with bearer token only
  ...
  //TODO this is the part which is different with default cookie jar
