...
void main() async {
  ...
  final dashboardPanelsService = DashboardPanelsService(
    clientService: clientService,
    networkService: networkService,
    cacheService: cacheService,
  );
  ...
  // Get all DashboardPanelss
  final getDashboardPanelssResult =
      await dashboardPanelsService.getDashboardPanelsAsync();

  switch (getDashboardPanelssResult) {
    case Success(value: final value):
      {
        print(value?.dashboardPanels);
      }
