...
void main() async {
  ...
  final tokenExConfigService = TokenExConfigService(
    clientService: clientService,
    networkService: networkService,
    cacheService: cacheService,
  );
  ...
  // Get all TokenExConfigs
  final getTokenExConfigsResult = await tokenExConfigService.getTokenExConfig();

  switch (getTokenExConfigsResult) {
