...
void main() async {
  ...
  final mobileContentService = MobileContentService(
    clientService: clientService,
    networkService: networkService,
    cacheService: cacheService,
  );
  ...
  final contentResult =
      await mobileContentService.getPageContentManagementClassic('shop');

  switch (contentResult) {
    case Success(value: final value):
      {
        print(value?.page?.widgets?.first.translatableFields?.slides);
      }
