...
void main() async {
  ...
  final catalogpagesService = CatalogpagesService(
    clientService: clientService,
    networkService: networkService,
    cacheService: cacheService,
  );
  ...
  // Get all Catalogpagess
  final getCatalogpagessResult = await catalogpagesService
      .getProductCatalogInformation("/ENcatalog/Cat1-Addison");

  switch (getCatalogpagessResult) {
