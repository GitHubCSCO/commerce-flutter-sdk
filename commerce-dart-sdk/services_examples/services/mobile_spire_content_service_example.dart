...
void main() async {
  ...
  final mobileSpireContentService = MobileSpireContentService(
    clientService: clientService,
    networkService: networkService,
    cacheService: cacheService,
  );
  ...
  // Get all orders
  final getContentResult =
      await mobileSpireContentService.getPageContenManagmentSpire('Shop');

  switch (getContentResult) {
    case Success(value: final value):
      {
        print(value?.page?.widgets?.first.translatableFields?.slides?.length);
      }
