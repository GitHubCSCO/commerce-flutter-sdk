...
void main() {
  late MobileContentService mobileContentService;
  ...
  group('MobileContentService', () {
    ...
    test(
        'getPageContentManagementClassic returns PageContentManagement on success',
        () async {
      // Arrange
      ...
      // Act
      final result =
          await mobileContentService.getPageContentManagementClassic(pageName);
    ...
    test('getPageContentManagementClassic fails if pageName is empty',
        () async {
      // Act
      final result =
          await mobileContentService.getPageContentManagementClassic('');
    ...
    test('getPageContentManagementClassic handles network failure gracefully',
        () async {
      // Arrange
